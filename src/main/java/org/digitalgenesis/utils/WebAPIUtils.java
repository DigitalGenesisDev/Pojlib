 ...
 * @apiNote Reimplemented from original QCXR Pojlib project.
 * @since 1.0
 * @author QCXR
 * @version 1.0
 *
...
public class WebAPIUtils {
    ...
    /** Parses the query parameters from a HashMap into a URL query string.
     * @param query The HashMap containing the query parameters.
     * @return A string representing the query parameters in URL format.
     */
