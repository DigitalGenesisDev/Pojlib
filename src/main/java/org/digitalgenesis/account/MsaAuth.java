...
public class MsaAuth {
    ...
    public MinecraftAccount performLogin(String msToken) throws MSAException {
        try {
            ...
            MinecraftAccount acc = MinecraftAccount.load(API.accountFilesDir, mcUuid);
    ...
    /** @return [uhs, token]*/
    private String[] acquireXsts(String xblToken) throws Exception {
    ...
    public boolean checkMcProfile(String mcAccessToken) throws IOException, JSONException {
